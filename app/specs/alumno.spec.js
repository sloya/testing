System.register(['../alumno'], function(exports_1, context_1) {
    "use strict";
    ...
    return {
        ...
        execute: function() {
            ...
            describe('Evalua clase alumno.ts parte I.', function () {
                var alumnoGeneral; //tambien se pueden crear variables globales que se ocupen en todas las pruebas
                //Cada prueba se pone en un metodo it.
                it('Prueba 1.1 Se comprueban calificaciones negativas.', function () {
                    var alumno = new alumno_1.Alumno(18, "Angel Jimenez", 0);
                ...
                it('Prueba 1.2 Se comprueban calificaciones superiores al 100.00.', function () {
                    var alumno = new alumno_1.Alumno(17, "Poncho Hernandez", 100.00);
                ...
                it('Prueba 1.3 Se comprueban calificaciones con decimales.', function () {
                    var alumnoGeneral = new alumno_1.Alumno(20, "Poncho Hernandez", 0);
                ...
                it('Prueba 1.4 Se comprueban nombre e id del alumno', function () {
                    var alumno = new alumno_1.Alumno(34, 'Juan Contreras', 0);
            ...
            describe('Evalua clase alumno.ts parte II. ', function () {
                it('Prueba 2.1 Se checa el nombre del alumno', function () {
                    var alumno = new alumno_1.Alumno(45, 'John Cooper', 56.44);
                ...
                it('Prueba 2.3 Se checa la estructura igual entre alumnos', function () {
                    var alumno1 = new alumno_1.Alumno(45, 'Juan', 25);
                    var alumno2 = new alumno_1.Alumno(45, 'Juan', 25);
                    var alumno3 = new alumno_1.Alumno(45, 'Juan', 23);
                ...
                it('Prueba 2.3 Se checa si tienen la misma referencia', function () {
                    var alumno1 = new alumno_1.Alumno(55, 'Poncho', 70);
                    var alumno2 = new alumno_1.Alumno(55, 'Poncho', 70);
                    var alumno3 = alumno1;
                ...
                it('Prueba 2.7 Se checa si la variable es truthy', function () {
                    ...
                    alumno = new alumno_1.Alumno(12, 'Pedro', 66.6);
                ...
                it('Prueba 2.8 Se checa si la variable es null', function () {
                    ...
                    alumno = new alumno_1.Alumno(44, "Enrique", 78);
            ...
            describe('Evalua clase alumno.ts parte III', function () {
                ...
                beforeAll(function () {
                    alumnoGeneral = new alumno_1.Alumno(12, "General", 44.5);
                });
                afterAll(function () {
                });
...
//# sourceMappingURL=alumno.spec.js.map